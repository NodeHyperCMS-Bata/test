...
class class_do_render_namumark:
    ...
    def do_render_text(self):
        # <b> function
        bold_user_set = get_main_skin_set(self.curs, self.flask_session, 'main_css_bold', self.id)
        ...
        # <s> function
        strike_user_set = get_main_skin_set(self.curs, self.flask_session, 'main_css_strike', self.id)
        ...
        while 1:
            ...
            if not link_data:
                ...
                if re.search(r'^(파일|file|외부|out):', link_main, flags = re.I):
                    ...
                    image_set = get_main_skin_set(self.curs, self.flask_session, 'main_css_image_set', self.id)
    ...
    def do_render_include(self):
        ...
        include_num = 0
        include_set_data = get_main_skin_set(self.curs, self.flask_session, 'main_css_include_link', self.id)
    ...
    def do_redner_footnote(self):
        ...
        footnote_set = get_main_skin_set(self.curs, self.flask_session, 'main_css_footnote_set', self.id)
        footnote_number_set = get_main_skin_set(self.curs, self.flask_session, 'main_css_footnote_number', self.id)
        footnote_number_view_set = get_main_skin_set(self.curs, self.flask_session, 'main_css_view_real_footnote_num', self.id)
    ...
    def do_render_list(self):
        ...
        list_view_set = get_main_skin_set(self.curs, self.flask_session, 'main_css_list_view_change', self.id)
    ...
    def do_render_last(self):
        ...
        if self.doc_include == '':
            if self.data_category != '':
                ...
                category_set_data = get_main_skin_set(self.curs, self.flask_session, 'main_css_category_set', self.id)
        ...
        if self.data_toc != '':
            ...
            toc_set_data = get_main_skin_set(self.curs, self.flask_session, 'main_css_toc_set', self.id)
