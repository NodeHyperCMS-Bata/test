...
!function (o) {
  ...
  }) : "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) ? (r = require("jquery"), n = function n(t, e) {
  ...
  var i = v.fn.dataTable,
    e = (v.extend(s.prototype, {
      ...
      _clonePosition: function _clonePosition(t) {
        var e = this.s.start,
      ...
      _mouseMove: function _mouseMove(t) {
        ...
        for (var e = this._eventToPage(t, "Y") - this.s.bodyTop, o = this.s.middles, r = null, n = this.s.dt, s = 0, i = o.length; s < i; s++) if (e < o[s]) {
          r = s;
          break;
        }
      ...
      _shiftScroll: function _shiftScroll(t) {
        var e,
          o,
          r = this,
  ...
  }), s.version = "1.3.3", v.fn.dataTable.RowReorder = s, v.fn.DataTable.RowReorder = s, v(b).on("init.dt.dtr", function (t, e, o) {
    var r, n;
