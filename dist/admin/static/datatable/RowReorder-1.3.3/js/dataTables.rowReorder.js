...
(function (factory) {
   ...
   */
  var RowReorder = function RowReorder(dt, opts) {
  ...
  $.extend(RowReorder.prototype, {
     ...
     * @private
     */
    _clone: function _clone(target) {
      var dt = this.s.dt;
      var clone = $(dt.table().node().cloneNode(false)).addClass('dt-rowReorder-float').append('<tbody/>').append(target.clone(false));
      ...
      var cloneParent = $('<div>').addClass('dt-rowReorder-float-parent').width(scrollWidth).append(clone).appendTo('body').scrollLeft(scrollLeft);
     ...
     * @private
     */
    _clonePosition: function _clonePosition(e) {
     ...
     * @private
     */
    _emitEvent: function _emitEvent(name, args) {
     ...
     * @private
     */
    _eventToPage: function _eventToPage(e, pos) {
     ...
     * @private
     */
    _mouseDown: function _mouseDown(e, target) {
      var that = this;
      var dt = this.s.dt;
      var start = this.s.start;
     ...
     * @private
     */
    _shiftScroll: function _shiftScroll(e) {
      var that = this;
      var dt = this.s.dt;
