...
!function (e) {
  ...
  }) : "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) ? (a = require("jquery"), i = function i(t, s) {
  ...
  function T(t, s, e, a, i) {
    var n,
      o = this;
    if (void 0 === i && (i = null), !C || !C.versionCheck || !C.versionCheck("1.10.0")) throw new Error("SearchPane requires DataTables 1.10 or newer");
    if (C.select) return t = new C.Api(t), this.classes = _.extend(!0, {}, T.classes), this.c = _.extend(!0, {}, T.defaults, s, i), s && s.hideCount && s.viewCount === b && (this.c.viewCount = !this.c.hideCount), s = t.columns().eq(0).toArray().length, this.s = {
      colExists: e < s,
      colOpts: b,
      ...
      countButton: _('<button type="button"></button>').addClass(this.classes.paneButton).addClass(this.classes.countButton),
      ...
      nameButton: _('<button type="button"></button>').addClass(this.classes.paneButton).addClass(this.classes.nameButton),
      panesContainer: a,
      searchBox: _("<input/>").addClass(this.classes.paneInputButton).addClass(this.classes.search),
      searchButton: _('<button type = "button"/>').addClass(this.classes.searchIcon).addClass(this.classes.paneButton),
  ...
  function M(t, s, e, a) {
    var l = this;
    if (void 0 === e && (e = !1), void 0 === a && (a = n), !y || !y.versionCheck || !y.versionCheck("1.10.0")) throw new Error("SearchPane requires DataTables 1.10 or newer");
    ...
    if (this.classes = P.extend(!0, {}, M.classes), this.c = P.extend(!0, {}, M.defaults, s), this.dom = {
      ...
      stateRead: !1,
      updating: !1
    }, !i.settings()[0]._searchPanes) return this._getState(), this.s.dt.page.info().serverSide && (h = this.s.dt.settings()[0], this.s.dt.on("preXhr.dtsps", function (t, s, e) {
      if (h === s) {
        e.searchPanes === b && (e.searchPanes = {}), e.searchPanes_null === b && (e.searchPanes_null = {});
        for (var a = 0, i = l.s.selectionList; a < i.length; a++) {
          var n = i[a],
            o = l.s.dt.column(n.column).dataSrc();
          e.searchPanes[o] === b && (e.searchPanes[o] = {}), e.searchPanes_null[o] === b && (e.searchPanes_null[o] = {});
          for (var r = 0; r < n.rows.length; r++) e.searchPanes[o][r] = n.rows[r], null === e.searchPanes[o][r] && (e.searchPanes_null[o][r] = !0);
        }
        0 < l.s.selectionList.length && (e.searchPanesLast = o), e.searchPanes_options = {
  ...
  function E(s, e, t) {
    var a = i.extend({
        filterChanged: function filterChanged(t) {
  ...
  return T.prototype.addRow = function (t, s, e, a, i, n, o) {
    ...
    this.s.dtPane && this.s.dtPane.off(".dtsp"), this.s.dt.off(".dtsp"), this.dom.clear.off(".dtsp"), this.dom.nameButton.off(".dtsp"), this.dom.countButton.off(".dtsp"), this.dom.searchButton.off(".dtsp"), this.dom.collapseButton.off(".dtsp"), _(this.s.dt.table().node()).off(".dtsp"), this.dom.container.detach();
    for (var t = _.fn.dataTable.ext.search.indexOf(this.s.searchFunction); -1 !== t;) _.fn.dataTable.ext.search.splice(t, 1), t = _.fn.dataTable.ext.search.indexOf(this.s.searchFunction);
    ...
    this.s.dtPane && (this.s.dtPane.off("select.dtsp").on("select.dtsp", function () {
      ...
      d.s.deselectTimeout = setTimeout(function () {
        d._updateSelection(!0), 0 === d.s.dtPane.rows({
          selected: !0
      ...
      if (_.isEmptyObject(e)) d.s.dtPane.state.clear();else {
        var a,
          i,
          n,
          o,
        ...
        }).toArray(), o = d.dom.searchBox.val(), i = d.s.dtPane.order(), a = d.s.rowData.binsOriginal, r = d.s.rowData.arrayOriginal, n = d.dom.collapseButton.hasClass(d.classes.rotated)), e.searchPanes === b && (e.searchPanes = {}), e.searchPanes.panes === b && (e.searchPanes.panes = []);
        for (var h = 0; h < e.searchPanes.panes.length; h++) e.searchPanes.panes[h].id === d.s.index && (e.searchPanes.panes.splice(h, 1), h--);
      ...
      d.s.dtPane.order([0, "asc" === t ? "desc" : "asc"]).draw(), d.s.dt.state.save();
    }), this.dom.countButton.off("click.dtsp").on("click.dtsp", function () {
      var t = d.s.dtPane.order()[0][1];
      d.s.dtPane.order([1, "asc" === t ? "desc" : "asc"]).draw(), d.s.dt.state.save();
    }), this.dom.collapseButton.off("click.dtsp").on("click.dtsp", function (t) {
      t.stopPropagation();
      t = _(d.s.dtPane.table().container());
      t.toggleClass(d.classes.hidden), d.dom.topRow.toggleClass(d.classes.bordered), d.dom.nameButton.toggleClass(d.classes.disabledButton), d.dom.countButton.toggleClass(d.classes.disabledButton), d.dom.searchButton.toggleClass(d.classes.disabledButton), d.dom.collapseButton.toggleClass(d.classes.rotated), t.hasClass(d.classes.hidden) ? d.dom.topRow.on("click.dtsp", function () {
      ...
      d.s.dtPane.search(t).draw(), "string" == typeof t && (0 < t.length || 0 === t.length && 0 < d.s.dtPane.rows({
        selected: !0
      }).data().toArray().length) ? d.dom.clear.removeClass(d.classes.disabledButton).removeAttr("disabled") : d.dom.clear.addClass(d.classes.disabledButton).attr("disabled", "true"), d.s.dt.state.save();
    ...
    if (t.searchPanes.options[s]) for (var e = 0, a = t.searchPanes.options[s]; e < a.length; e++) {
      var i = a[e];
    ...
    if (t !== b) {
      ...
      for (var i = 0, n = t; i < n.length; i++) {
        ...
        if ("function" == typeof o.value) {
          for (var h = 0; h < e.length; h++) o.value.call(this.s.dt, e[h], s[0][h]) && l.total++;
    ...
    this.updateTable(), this.s.updating = !0, this.s.dt.draw(!1), this.s.updating = !1;
  }, T.prototype._populatePaneArray = function (t, s, e, a) {
    var i;
    void 0 === a && (a = this.s.rowData.bins), "string" == typeof this.s.colOpts.orthogonal ? (i = e.oApi._fnGetCellData(e, t, this.s.index, this.s.colOpts.orthogonal), this.s.rowData.filterMap.set(t, i), this._addOption(i, i, i, i, s, a)) : ("string" == typeof (i = null === (i = e.oApi._fnGetCellData(e, t, this.s.index, this.s.colOpts.orthogonal.search)) ? "" : i) && (i = i.replace(/<[^>]*>/g, "")), this.s.rowData.filterMap.set(t, i), a[i] ? a[i]++ : (a[i] = 1, this._addOption(i, e.oApi._fnGetCellData(e, t, this.s.index, this.s.colOpts.orthogonal.display), e.oApi._fnGetCellData(e, t, this.s.index, this.s.colOpts.orthogonal.sort), e.oApi._fnGetCellData(e, t, this.s.index, this.s.colOpts.orthogonal.type), s, a))), this.s.rowData.totalOptions++;
  }, T.prototype._reloadSelect = function (t) {
    if (t !== b) {
      for (var s, e = 0; e < t.searchPanes.panes.length; e++) if (t.searchPanes.panes[e].id === this.s.index) {
        s = e;
        break;
      }
      if (s) for (var a = this.s.dtPane, i = a.rows({
          order: "index"
        }).data().map(function (t) {
    ...
    function s() {
      e.s.scrollTop = _(e.s.dtPane.table().node()).parent()[0].scrollTop, e.s.dt.page.info().serverSide && !e.s.updating ? e.s.serverSelecting || (e.s.serverSelect = e.s.dtPane.rows({
        selected: !0
      }).data().toArray(), e.s.dt.draw(!1)) : t && e._makeSelection(), i._fnProcessingDisplay(a, !1);
    }
    var e = this,
    ...
    if (Array.isArray(t) || t instanceof C.Api) {
      if (t instanceof C.Api && (t = t.toArray(), s = s.toArray()), t.length !== s.length) throw new Error("display and filter not the same length");
      for (var o = 0; o < t.length; o++) n[t[o]] ? n[t[o]]++ : (n[t[o]] = 1, i.push({
        display: s[o],
        filter: t[o],
        sort: e[o],
        type: a[o]
      })), this.s.rowData.totalOptions++;
    } else "string" == typeof this.s.colOpts.orthogonal ? (n[t] ? n[t]++ : (n[t] = 1, i.push({
      display: s,
      filter: t,
      sort: e,
      type: a
    ...
    if (this.s.listSet && (i = this.s.dt.state()), this.s.colExists) {
      var n = -1;
      if (i && i.searchPanes && i.searchPanes.panes) for (var o = 0; o < i.searchPanes.panes.length; o++) if (i.searchPanes.panes[o].id === this.s.index) {
        n = o;
        break;
      }
      if ((!1 === this.s.colOpts.show || this.s.colOpts.show !== b && !0 !== this.s.colOpts.show) && -1 === n) return this.dom.container.addClass(this.classes.hidden), this.s.displayed = !1;
      if (!0 !== this.s.colOpts.show && -1 === n || (this.s.displayed = !0), this.s.dt.page.info().serverSide || s && s.searchPanes && s.searchPanes.options) s && s.searchPanes && s.searchPanes.options && this._serverPopulate(s);else {
        ...
        if (!1 === this.s.displayed && ((this.s.colOpts.show === b && null === this.s.colOpts.threshold ? l > this.c.threshold : l > this.s.colOpts.threshold) || !0 !== this.s.colOpts.show && r <= 1)) return this.dom.container.addClass(this.classes.hidden), void (this.s.displayed = !1);
        this.dom.container.addClass(this.classes.show), this.s.displayed = !0;
      }
    } else this.s.displayed = !0;
    this._displayPane(), this.s.listSet || this.dom.dtP.on("stateLoadParams.dtsp", function (t, s, e) {
    ...
    l = _.fn.dataTable.ext.errMode, _.fn.dataTable.ext.errMode = "none", this.s.dtPane = this.dom.dtP.DataTable(_.extend(!0, this._getPaneConfig(), this.c.dtOpts, this.s.colOpts ? this.s.colOpts.dtOpts : {}, this.s.colOpts.options || !this.s.colExists ? {
      createdRow: function createdRow(t, s) {
    ...
    if (!this.s.dt.page.info().serverSide) for (var s = 0, e = this.s.dt.rows().indexes().toArray(); s < e.length; s++) {
      var a = e[s];
    ...
    for (var e = this.s.colOpts, a = this.s.dt, i = 0, n = this.s.selections; i < n.length; i++) {
      ...
      } else if (t === o || ("string" != typeof t || 0 !== t.length) && t == o || null === o && "string" == typeof t && "" === t) return !0;
    }
    ...
    -1 < e && (s[e] = ""), 0 < s.length ? a.addClass(this.classes.selected) : 0 === s.length && a.removeClass(this.classes.selected), this.s.updating = t;
    ...
    threshold: .6,
    viewCount: !0
  }, n = T, (o && o.__extends || (_a = function a(t, s) {
    ...
    _a(t, s), t.prototype = null === s ? Object.create(s) : (e.prototype = s.prototype, new e());
  }))(s, r = n), s.prototype._serverPopulate = function (t) {
    this.s.rowData.binsShown = {}, this.s.rowData.arrayFilter = [], t.tableLength !== b ? (this.s.tableLength = t.tableLength, this.s.rowData.totalOptions = this.s.tableLength) : (null === this.s.tableLength || this.s.dt.rows()[0].length > this.s.tableLength) && (this.s.tableLength = this.s.dt.rows()[0].length, this.s.rowData.totalOptions = this.s.tableLength);
    var s = this.s.dt.column(this.s.index).dataSrc();
    if (t.searchPanes.options[s] !== b) for (var e = 0, a = t.searchPanes.options[s]; e < a.length; e++) {
      var i = a[e];
      this.s.rowData.arrayFilter.push({
        display: i.label,
        filter: i.value,
        ...
        total: +i.total,
        type: i.label
      }), this.s.rowData.binsShown[i.value] = +i.count, this.s.rowData.bins[i.value] = +i.total;
    }
    t = Object.keys(this.s.rowData.bins).length, s = this._uniqueRatio(t, this.s.tableLength);
    if (!this.s.colOpts.show && !1 === this.s.displayed && ((this.s.colOpts.show === b && null === this.s.colOpts.threshold ? s > this.c.threshold : s > this.s.colOpts.threshold) || !0 !== this.s.colOpts.show && t <= 1)) this.dom.container.addClass(this.classes.hidden), this.s.displayed = !1;else if (this.s.rowData.arrayOriginal = this.s.rowData.arrayFilter, this.s.rowData.binsOriginal = this.s.rowData.bins, this.s.displayed = !0, this.s.dtPane) {
      var n = this.s.serverSelect;
      this.s.dtPane.rows().remove();
      for (var o = 0, r = this.s.rowData.arrayFilter; o < r.length; o++) {
        var l = r[o];
        if (this._shouldAddRow(l)) for (var h = this.addRow(l.display, l.filter, l.sort, l.type), d = 0; d < n.length; d++) if ((u = n[d]).filter === l.filter) {
          this.s.serverSelecting = !0, h.select(), this.s.serverSelecting = !1, n.splice(d, 1), this.s.selections.push(l.filter);
          break;
        }
      }
      for (var c = 0, p = n; c < p.length; c++) for (var u = p[c], f = 0, g = this.s.rowData.arrayOriginal; f < g.length; f++) (l = g[f]).filter === u.filter && (h = this.addRow(l.display, l.filter, l.sort, l.type), this.s.serverSelecting = !0, h.select(), this.s.serverSelecting = !1, this.s.selections.push(l.filter));
      this.s.serverSelect = this.s.dtPane.rows({
        selected: !0
      }).data().toArray(), this.s.dtPane.draw();
    }
    ...
    for (var a = 0, i = this.s.dtPane.rows().data().toArray(); a < i.length; a++) {
      var n = i[a];
      n.shown = "number" == typeof this.s.rowData.binsShown[n.filter] ? this.s.rowData.binsShown[n.filter] : 0, this.s.dtPane.row(n.index).data(n);
    }
    ...
    if (Array.isArray(s)) for (var n = 0, o = s; n < o.length; n++) a(o[n]);else a(s);
  }, t = s, (o && o.__extends || (_l = function l(t, s) {
    ...
    _l(t, s), t.prototype = null === s ? Object.create(s) : (e.prototype = s.prototype, new e());
  ...
  }, u = e, (o && o.__extends || (_c = function c(t, s) {
    ...
    _c(t, s), t.prototype = null === s ? Object.create(s) : (e.prototype = s.prototype, new e());
    ...
    if (this.s.colOpts.options || this.s.customPaneSettings && this.s.customPaneSettings.options) {
      ...
      for (var s = this.s.dtPane.rows().toArray()[0], e = 0; e < s.length; e++) {
        ...
        if (a !== b) if (0 === a.shown) u.remove(), s = this.s.dtPane.rows().toArray()[0], e--;else for (var i = 0, n = t; i < n.length; i++) {
          var o = n[i];
      ...
      for (var d = 0, c = this.s.rowData.arrayFilter; d < c.length; d++) {
        var p = c[d];
        if (0 !== p.shown) for (var u = this.addRow(p.display, p.filter, p.sort, p.type, b), e = 0; e < t.length; e++) if ((o = t[e]).filter === p.filter) {
          u.select(), t.splice(e, 1), this.s.selections.push(p.filter);
          break;
        }
      }
      for (var f = 0, g = t; f < g.length; f++) for (var o = g[f], m = 0, w = this.s.rowData.arrayOriginal; m < w.length; m++) (p = w[m]).filter === o.filter && ((u = this.addRow(p.display, p.filter, p.sort, p.type, b)).select(), this.s.selections.push(p.filter));
    }
    ...
    this.s.rowData.arrayFilter = [], this.s.rowData.bins = {};
    var t = this.s.dt.settings()[0];
    if (!this.s.dt.page.info().serverSide) for (var s = 0, e = this.s.dt.rows({
        search: "applied"
    ...
    if (t !== b) {
      ...
      for (var o = 0, r = t; o < r.length; o++) {
        ...
        if ("function" == typeof l.value) {
          for (var c = 0; c < a.length; c++) l.value.call(this.s.dt, a[c], s[0][c]) && d.total++;
          for (c = 0; c < i.length; c++) l.value.call(this.s.dt, i[c], e[0][c]) && d.shown++;
    ...
    return 0 < t.shown;
  }, w = L, (o && o.__extends || (_g = function g(t, s) {
    ...
    _g(t, s), t.prototype = null === s ? Object.create(s) : (e.prototype = s.prototype, new e());
    ...
    for (var t = 0, s = this.s.panes; t < s.length; t++) (e = s[t]).s.dtPane && (e.s.scrollTop = e.s.dtPane.table().node().parentNode.scrollTop);
    this.dom.container.find("." + this.classes.search.replace(/\s+/g, ".")).each(function () {
      P(this).val("").trigger("input");
    }), this.s.selectionList = [];
    for (var e, a = [], i = 0, n = this.s.panes; i < n.length; i++) (e = n[i]).s.dtPane && a.push(e.clearPane());
    return a;
  }, M.prototype.getNode = function () {
    return this.dom.container;
  }, M.prototype.rebuild = function (t, s) {
    void 0 === t && (t = !1), void 0 === s && (s = !1), this.dom.emptyMessage.detach(), !1 === t && this.dom.panes.empty();
    ...
    if ("auto" === this.c.layout) {
      for (var t = P(this.s.dt.searchPanes.container()).width(), t = Math.floor(t / this.s.minPaneWidth), s = 1, e = 0, a = [], i = 0, n = this.s.panes; i < n.length; i++) (d = n[i]).s.displayed && a.push(d.s.index);
      var o = a.length;
      if (t === o) s = t;else for (var r = t; 1 < r; r--) {
        var l = o % r;
        if (0 == l) {
          s = r, e = 0;
          break;
    ...
    } else for (var d, c = 0, p = this.s.panes; c < p.length; c++) (d = p[c]).adjustTopRow();
    return this;
    ...
    this.s.dt.on("stateLoadParams.dtsps", function (t, s, e) {
      if (e.searchPanes !== b && s === d) {
        if (h.clearSelections(), h.s.selectionList = e.searchPanes.selectionList || [], e.searchPanes.panes) for (var a = 0, i = e.searchPanes.panes; a < i.length; a++) for (var n = i[a], o = 0, r = h.s.panes; o < r.length; o++) {
          var l = r[o];
    ...
    var t = this;
    this.dom.titleRow.removeClass(this.classes.hide).detach().append(this.dom.title), this.c.clear && this.dom.clearAll.appendTo(this.dom.titleRow).on("click.dtsps", function () {
    ...
    this.dom.container.text("").removeClass(this.classes.hide).append(this.dom.titleRow).append(this.dom.panes), this.s.panes.forEach(function (t) {
    ...
    t && this.dom.collapseAll.addClass(this.classes.disabledButton).attr("disabled", "true"), s && this.dom.showAll.addClass(this.classes.disabledButton).attr("disabled", "true");
  }, M.prototype._checkMessage = function () {
    for (var t = 0, s = this.s.panes; t < s.length; t++) if (!0 === s[t].s.displayed) return this.dom.emptyMessage.detach(), void this.dom.titleRow.removeClass(this.classes.hide);
    this._attachMessage();
    ...
    for (var s = 0, e = t; s < e.length; s++) {
      ...
      if (i && i.s.dtPane) {
        for (var l = 0; l < i.s.dtPane.rows().data().toArray().length; l++) a.rows.includes("function" == typeof i.s.dtPane.row(l).data().filter ? i.s.dtPane.cell(l, 0).data() : i.s.dtPane.row(l).data().filter) && i.s.dtPane.row(l).select();
        i.updateTable();
      }
    }
    ...
    for (var a = this, i = (t.columns(0 < this.c.columns.length ? this.c.columns : b).eq(0).each(function (t) {
      ...
      }), t.columns().eq(0).toArray().length), n = 0; n < this.c.panes.length; n++) this.s.panes.push(new this.s.paneClass(s, e, i + n, this.dom.panes, this.c.panes[n]));
    ...
    this.dom.collapseAll.on("click.dtsps", function () {
      t._collapseAll(), t.dom.collapseAll.addClass(t.classes.disabledButton).attr("disabled", "true"), t.dom.showAll.removeClass(t.classes.disabledButton).removeAttr("disabled"), t.s.dt.state.save();
    }), this.dom.showAll.on("click.dtsps", function () {
      t._showAll(), t.dom.showAll.addClass(t.classes.disabledButton).attr("disabled", "true"), t.dom.collapseAll.removeClass(t.classes.disabledButton).removeAttr("disabled"), t.s.dt.state.save();
    });
    for (var s = 0, e = this.s.panes; s < e.length; s++) e[s].dom.topRow.on("collapse.dtsps", function () {
    ...
    for (var d = this, c = (this._attach(), this.dom.panes.empty(), this.s.dt.settings()[0]), t = 0, s = this.s.panes; t < s.length; t++) {
      var e = s[t];
      e.rebuildPane(0 < Object.keys(this.s.serverData).length ? this.s.serverData : b), this.dom.panes.append(e.dom.container);
    }
    ...
    var a = this.s.dt.state.loaded(),
      n = (!this.s.stateRead && a && this.s.dt.page(a.start / this.s.dt.page.len()).draw("page"), this.s.stateRead = !0, this._checkMessage(), i.on("preDraw.dtsps", function () {
        d.s.updating || d.s.paging || (d._updateFilterCount(), d._updateSelection()), d.s.paging = !1;
        ...
        d.s.paging = !0, d.s.pagingST = !0, d.s.page = d.s.dt.page();
        ...
        if (s === c) {
          ...
          for (var a = 0, i = 0, n = d.s.panes; i < n.length; i++) {
            ...
            if (e.searchPanes[r] || (e.searchPanes[r] = {}), e.searchPanes_null[r] || (e.searchPanes_null[r] = {}), o.s.dtPane) for (var l = o.s.dtPane.rows({
                selected: !0
              }).data().toArray(), h = 0; h < l.length; h++) e.searchPanes[r][h] = l[h].filter, e.searchPanes[r][h] || (e.searchPanes_null[r][h] = !0), a++;
          }
          0 < a && (a !== d.s.filterCount ? (e.start = 0, d.s.page = 0) : e.start = d.s.page * d.s.dt.page.len(), d.s.dt.page(d.s.page), d.s.filterCount = a), 0 < d.s.selectionList.length && (e.searchPanesLast = d.s.dt.column(d.s.selectionList[d.s.selectionList.length - 1].column).dataSrc()), e.searchPanes_options = {
        ...
        s.nTable !== d.s.dt.table().node() || d.s.dt.page.info().serverSide || (i = !1, d.s.dt.one("preDraw.dtsps", function () {
          if (!i) {
            ...
            for (var s = 0, e = d.s.panes; s < e.length; s++) {
              var a = e[s];
              a.clearData(), a.rebuildPane(b, !0), d.dom.panes.append(a.dom.container);
            }
            d.s.dt.page.info().serverSide || d.s.dt.draw(), d.s.updating = !1, d._updateSelection(), d._checkMessage(), d.s.dt.one("draw.dtsps", function () {
              d.s.updating = !0, d.s.dt.page(t).draw(!1), d.s.updating = !1;
            });
          }
        }));
      }), this.c.preSelect);
    a && a.searchPanes && a.searchPanes.selectionList && (n = a.searchPanes.selectionList), this._makeSelections(n), this._updateFilterCount(), i.on("destroy.dtsps", function (t, s) {
      if (s === c) {
        for (var e = 0, a = d.s.panes; e < a.length; e++) a[e].destroy();
        i.off(".dtsps"), d.dom.showAll.off(".dtsps"), d.dom.clearAll.off(".dtsps"), d.dom.collapseAll.off(".dtsps"), P(i.table().node()).off(".dtsps"), d.dom.container.detach(), d.clearSelections();
      }
    }), this.c.collapse && this._setCollapseListener(), this.c.clear && this.dom.clearAll.on("click.dtsps", function () {
    ...
    this.dom.title.html(this.s.dt.i18n("searchPanes.title", this.c.i18n.title, t)), this.c.filterChanged && "function" == typeof this.c.filterChanged && this.c.filterChanged.call(this.s.dt, t), 0 === t ? this.dom.clearAll.addClass(this.classes.disabledButton).attr("disabled", "true") : this.dom.clearAll.removeClass(this.classes.disabledButton).removeAttr("disabled");
  }, M.version = "2.1.2", M.classes = {
    clear: "dtsp-clear",
    clearAll: "dtsp-clearAll",
    collapseAll: "dtsp-collapseAll",
    ...
    viewCount: !0,
    viewTotal: !1
  }, O = M, (o && o.__extends || (_x = function x(t, s) {
    return (_x = Object.setPrototypeOf || ({
      __proto__: []
    } instanceof Array ? function (t, s) {
      t.__proto__ = s;
    } : function (t, s) {
    ...
    _x(t, s), t.prototype = null === s ? Object.create(s) : (e.prototype = s.prototype, new e());
    ...
    for (var t = 0, s = this.s.panes; t < s.length; t++) {
      ...
      if (e.s.colOpts.show) {
        var a = this.s.dt.column(e.s.index).dataSrc(),
          i = !0;
        if (this.s.serverData.searchPanes.options[a]) for (var n = 0, o = this.s.serverData.searchPanes.options[a]; n < o.length; n++) {
          var r = o[n];
          if (r.total !== r.count) {
            i = !1;
            break;
    ...
    function t(t, s, e) {
      if (e.searchPanes !== b) {
        if (h.s.selectionList = e.searchPanes.selectionList || [], e.searchPanes.panes) for (var a = 0, i = e.searchPanes.panes; a < i.length; a++) for (var n = i[a], o = 0, r = h.s.panes; o < r.length; o++) {
          var l = r[o];
          n.id === l.s.index && l.s.dtPane && (l.dom.searchBox.val(n.searchTerm), l.s.dtPane.order(n.order));
        }
    ...
    var t;
    void 0 === s && (s = b), this.s.pagingST ? this.s.pagingST = !1 : this.s.updating || s && s.s.serverSelecting || (s !== b && (this.s.dt.page.info().serverSide && s._updateSelection(), t = s.s.dtPane.rows({
      selected: !0
    }).data().toArray().map(function (t) {
      return t.filter;
    ...
    if (this.s.updating = !0, this.s.dt.page.info().serverSide) {
      ...
      for (var t = 0, s = this.s.panes; t < s.length; t++) !(O = s[t]).s.displayed || h && O.s.index === h.s.index || O.updateRows();
    } else {
      var e = this.s.selectionList,
        a = !1;
      this.clearSelections(), this.s.dt.draw(!1), this.s.dt.rows().toArray()[0].length > this.s.dt.rows({
        search: "applied"
      }).toArray()[0].length && (a = !0), this.s.selectionList = e;
      for (var i = 0, n = this.s.panes; i < n.length; i++) (h = n[i]).s.displayed && (h.s.filteringActive = a, h.updateRows());
      for (var o = 0, r = this.s.selectionList; o < r.length; o++) {
        ...
        if (h.s.dtPane) {
          ...
          if (h.s.selections = l.rows, 0 !== l.rows.length) {
            this.s.dt.draw(!1);
            for (var y = 0, b = 0, _ = 0, C = 0, S = this.s.panes; C < S.length; C++) (O = S[C]).s.dtPane && b < (y += O.getPaneCount()) && (_++, b = y);
            for (var O, x = 0 < y, A = 0, D = this.s.panes; A < D.length; A++) (O = D[A]).s.displayed && (a || h.s.index !== O.s.index || !x ? O.s.filteringActive = x || a : 1 === _ && (O.s.filteringActive = !1), O.s.index !== h.s.index) && O.updateRows();
          }
        }
      }
      this.s.dt.draw(!1);
    ...
    action: function action(t, s) {
      s.searchPanes.clearSelections();
    },
    text: "Clear Panes"
  }, B.ext.buttons.searchPanes = {
    action: function action(t, s, e, a) {
      var i = this;
      a._panes ? (this.popover(a._panes.getNode(), {
        align: "container",
        span: "container"
      }), a._panes.rebuild(b, !0)) : (this.processing(!0), setTimeout(function () {
        E(s, e, a), i.popover(a._panes.getNode(), {
          align: "container",
          span: "container"
        }), a._panes.rebuild(b, !0), i.processing(!1);
      }, 10));
    },
    init: function init(t, s, e) {
      t.button(s).text(e.text || t.i18n("searchPanes.collapse", "SearchPanes", 0)), t.init().stateSave && E(t, s, e);
    },
    config: {},
    text: ""
