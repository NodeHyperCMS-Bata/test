...
!function (a) {
  ...
  }) : "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) ? (u = require("jquery"), o = function o(t, e) {
    e.fn.dataTable || require("datatables.net")(t, e);
  }, "undefined" != typeof window ? module.exports = function (t, e) {
    return t = t || window, e = e || u(t), o(t, e), a(e, 0, t.document);
  } : (o(window, u), module.exports = a(u, window, window.document))) : a(jQuery, window, document);
}(function (t, e, a, u) {
  "use strict";

  var o = t.fn.dataTable,
    n = "fg-toolbar ui-toolbar ui-widget-header ui-helper-clearfix ui-corner-";
  return t.extend(!0, o.defaults, {
