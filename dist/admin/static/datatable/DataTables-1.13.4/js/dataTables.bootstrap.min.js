...
!function (t) {
  ...
  return x.extend(!0, r.defaults, {
  ...
  }), r.ext.renderer.pageButton.bootstrap = function (s, e, d, a, l, c) {
    function u(e, a) {
      for (var t, n, i = function i(e) {
          e.preventDefault(), x(e.currentTarget).hasClass("disabled") || b.page() == e.data.action || b.page(e.data.action).draw("page");
        }, r = 0, o = a.length; r < o; r++) if (t = a[r], Array.isArray(t)) u(e, t);else {
        switch (f = p = "", t) {
          case "ellipsis":
            p = "&#x2026;", f = "disabled";
            break;
        ...
        p && (n = -1 !== f.indexOf("disabled"), n = x("<li>", {
          ...
          id: 0 === d && "string" == typeof t ? s.sTableId + "_" + t : null
        }).append(x("<a>", {
          href: n ? null : "#",
        ...
        }).html(p)).appendTo(e), s.oApi._fnBindAction(n, {
          action: t
        }, i));
      }
    }
    var p,
      ...
      w = s.oLanguage.oAria.paginate || {};
    try {
      t = x(e).find(n.activeElement).data("dt-idx");
    } catch (e) {}
    u(x(e).empty().html('<ul class="pagination"/>').children("ul"), a), t !== i && x(e).find("[data-dt-idx=" + t + "]").trigger("focus");
  }, r;
});