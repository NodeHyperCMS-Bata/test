...
function render(data, basicdata, page, callback) {
  if (_fs["default"].existsSync(__dirname + '/ejs/' + page + '.ejs')) {
    Object.assign(data, {
      title: '',
      mainflex: true,
    ...
    _ejs["default"].renderFile(__dirname + '/ejs/' + page + '.ejs', Object.assign(basicdata, data), {}, function (err, str) {
      _ejs["default"].renderFile(__dirname + '/ejs/layout.ejs', Object.assign(basicdata, {
        title: data.title,
