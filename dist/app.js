...
var sessionDatabase = new _database.Database('sessions');
var sessionMiddleware = (0, _expressSession["default"])({
  secret: "keyboard cat",
  resave: false,
  saveUninitialized: true,
  store: new ((0, _sessionStore["default"])(_expressSession["default"]))(sessionDatabase),
  name: 'PHPSESSID'
});
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res, next) {
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 2:
          req.siteInfo = _context.sent;
          req.userInfo = req.session.userInfo;
          req.userName = req.session.username;
          res.msgRedirect = function (link, data) {
            req.session.msg = data;
            req.session.save(function () {
              res.redirect(link);
            });
          };
          res.errMsgRedirect = function (link, data) {
            req.session.errMsg = data;
            req.session.save(function () {
              res.redirect(link);
            });
          };
          req.removeMsg = function () {
            delete req.session.msg;
            //if(Object.keys(req.session).length === 0) req.session.destroy((err) => {});
          };

          req.removeErrMsg = function () {
  ...
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res, next) {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          if (!(req.path.startsWith('/admin') && (_req$userInfo = req.userInfo) !== null && _req$userInfo !== void 0 && _req$userInfo.isadmin)) {
            _context2.next = 3;
            break;
          }
          next();
        ...
        case 8:
          ...
          _context2.next = 12;
          return _site.tables.visit.set(visits);
        case 12:
          next();
        case 13:
        case "end":
